package com.yk.customsdk.customlibiary.compress;
...
public class CompressHelper {
    ...
    private CompressHelper(Context context) {
        ...
        destinationDirectoryPath = Environment
                .getExternalStorageDirectory().getPath() + File.separator + "CatchUAndroid"
                + File.separator + "compress" + File.separator;
    }
